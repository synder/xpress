...
/**
 * @desc requester sign
 * @params {String} key appKey
 * @params {String} secret appSecret
...
/**
 * @desc method to check signature
 * @params {String} key appKey
 * @params {String} secret appSecret
 * @params {String} timestamp
 * @params {String} signature
 * @return {Boolean} signature == sign(key, secret, timestamp)
 * */
...
/**
 * @desc get appKey from request headers
 * @params {http.IncomingMessage} req
 * @return appKey
 * */
...
/**
 * @desc get timestamp from request headers
 * @params {http.IncomingMessage} req
 * @return timestamp
 * */
...
/**
 * @desc get signature from request headers
 * @params {http.IncomingMessage} req
 * @return signature
 * */
...
/**
 * @desc send request to http server
 * */
