...
var Xpress = function (options) {
    ...
    this.__defaultHeaders = {
        version: options.versionHeader || 'X-Accept-Version',
        channel: options.channelHeader || 'X-Client-Channel'
    };
 ...
 * */
Xpress.prototype.__version = function () {
    var self = this;
    this.app.use(function (req, res, next) {
        req.version = req.get(self.__defaultHeaders.version); //api版本
        req.channel = req.get(self.__defaultHeaders.channel); //api通道
        next();
    });
};
...
Xpress.prototype.__method = function () {
    route.method(Xpress, this, this.app);
};
 ...
 * });
 * */
Xpress.prototype.setting = function (fn) {
    fn(this.app);
};
 ...
 * @param fn {Function} function(app){}
 * */
Xpress.prototype.route = function (fn) {
    fn(this.app);
};
 ...
 * */
Xpress.prototype.error = function (fn) {
    fn(this.app);
};
